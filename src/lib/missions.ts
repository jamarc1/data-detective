...
export const MISSION_1: Mission = {
  ...
  tasks: [
    ...
    },
    {
      ...
      objective: "Find all guests in the people table who attended the Vantage Gala.",
  ...
  tasks: [
    {
      ...
      objective: "Find everyone in guest_scans who checked in after soundcheck ended (after 21:40:00).",
      chiefLine:
    ...
    },
    {
      ...
      objective: "Join all three logs together and lay out the full night in time order.",
    ...
    },
    {
      ...
      objective: "Cross-reference staff_shifts and rideshare_pickups to find whose statement doesn't match the timeline.",
