  ...
  tasks: [
    {
      ...
      sqlStarter: "SELECT *\nFROM ...",
      answerSql: "SELECT *\nFROM crimes;",
      expectedResult: "You should see the case archive and identify the open Vantage Gala Heist.",
      successDialogue: [
    ...
    },
    {
      ...
      detectiveQuestion: "Who was at the gala?",
      instructions: "Pull the guest list.",
      starterSql: "SELECT *\nFROM ...\n",
      sqlStarter: "SELECT *\nFROM ...",
      answerSql: "SELECT *\nFROM people;",
      expectedResult: "You should see everyone who attended the gala.",
    ...
    },
    {
      ...
      expectedResult: "Only suspicious guests should appear.",
    ...
    },
    {
      ...
      expectedResult: "The latest last_seen_time should appear first.",
